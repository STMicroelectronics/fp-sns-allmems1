...
set NAME_FW=STM32F446RE-Nucleo_IKS01A2_ALLMEMS1\Exe\STM32F446RE-Nucleo_IKS01A2_ALLMEMS1
set BOOTLOADER="..\..\..\..\..\..\Utilities\BootLoader\STM32F4xxRE\BootLoaderF446RE-Nucleo.bin"
color 0F
echo                /******************************************/
