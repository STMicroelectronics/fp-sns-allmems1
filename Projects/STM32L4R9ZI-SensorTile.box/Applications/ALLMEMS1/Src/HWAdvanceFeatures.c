/**
  ...
  * @version 4.2.0
  * @date    07-Feb-2022
  * @brief   LSM6DSOX HW Advance Features API
  ******************************************************************************
  * @attention
  *
...
void EnableHWOrientation6D(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_6D_Orientation(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!=BSP_ERROR_NONE) {
...
void EnableHWTilt(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_Tilt_Detection(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!=BSP_ERROR_NONE) {
...
void EnableHWWakeUp(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_Wake_Up_Detection(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!= BSP_ERROR_NONE) {
...
void EnableHWFreeFall(void)
{
  ...
  /* Enable Free Fall detection */
  if(BSP_MOTION_SENSOR_Enable_Free_Fall_Detection(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!= BSP_ERROR_NONE) {
  ...
  if(BSP_MOTION_SENSOR_Set_Free_Fall_Threshold(ACCELERO_INSTANCE,FF_TSH_250mg) != BSP_ERROR_NONE) {
...
void EnableHWDoubleTap(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_Double_Tap_Detection(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!= BSP_ERROR_NONE) {
...
void EnableHWSingleTap(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_Single_Tap_Detection(ACCELERO_INSTANCE, MOTION_SENSOR_INT1_PIN)!= BSP_ERROR_NONE) {
...
void EnableHWPedometer(void)
{
  ...
  if(BSP_MOTION_SENSOR_Enable_Pedometer(ACCELERO_INSTANCE) != BSP_ERROR_NONE) {
...
{
  if (BSP_MOTION_SENSOR_Step_Counter_Reset( ACCELERO_INSTANCE ) != BSP_ERROR_NONE ){
